...
export default function Blogs() {
    return(
      ...
      <h1 className="text-4xl font-bold mb-6 text-center text-[#003300]">Healthy Diet Blog</h1>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {posts.map(post => (
          <Link key={post.id} href={`/blogs/${post.id}`}>
            <div className="block p-4 border rounded-lg shadow hover:shadow-lg transition  bg-lime-50">
        ...
        className="block mt-4 text-center  bg-lime-50 text-slate-900 py-2 px-4 rounded hover:bg-lime-300 outline outline-lime-300"
      >
        Read More
      </button>
            </div>
